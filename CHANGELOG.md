...
- Enhanced `vwo_sdkUsageStats` event payload with `settingsFetchTime`, `sdkInitTime`, and `initConfig` (the SDK initialization options) for better observability into SDK initialization.
