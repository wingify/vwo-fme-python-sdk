...
class SetAttributeApi:
    ...
    def create_and_send_impression_for_attribute(
        ...
        properties = get_events_base_properties(
            EventEnum.SYNC_VISITOR_PROP.value,
        ...
        payload = get_attribute_payload_data(
            settings, context, EventEnum.SYNC_VISITOR_PROP.value, attribute_map
        )

        from wingify.wingify_client import WingifyClient as VWOClient
